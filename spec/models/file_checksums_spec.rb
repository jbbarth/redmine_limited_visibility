...
describe "FileChecksums" do
  ...
  it "should core blocks checksums" do
    ...
    assert_checksum %w(c5bbcca4fa2ed57299032384413f1db6 a6f615004d7bc9f35a9ac7671329e181 ab1a2d08e1b058f6b8ae0466dce9e679), "app/views/roles/index.html.erb"
  end
  ...
  it "should repeat any change in my/page" do
    ...
    assert_checksum %w(3e32d220ab995585eadcc4f575b3d640 906a83136fed11e7e1bea073e767eadb), "app/views/my/page.html.erb"
  end
  ...
  it "should break if issues and projects api are updated" do
    ...
    assert_checksum %w(015cf9545f9d4078106b30311ded7f9b b0bd5d52f496b2b43265cb4d2e49951e b28a2d536393ccc96458a5c3a81d70dd), "app/views/issues/show.api.rsb"
    assert_checksum %w(5a39fb497ffc11649bd11e7b5d62b25e 41537d1ac617502a3d7770e7567a494c 6bd3458d0bae709cb00e183888e31439 173f425fb9f6bbc4b3c964ad7eb9c302), "app/views/users/show.api.rsb"
  end
